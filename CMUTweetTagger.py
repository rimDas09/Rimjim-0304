...
def check_script_is_present(run_tagger_cmd=RUN_TAGGER_CMD):
    ...
    try:
        ...
        print ("Caught an OSError, have you specified the correct path to runTagger.sh? We are using \"%s\". "
               "Exception: %r" % (run_tagger_cmd, repr(err)))
    return success
